...
export default function UeberUns() {
  return (
    <>
      ...
      {/* Dunkler Bruch, spiegelbildlich zum "Dunklen Einschub" auf der
          Startseite — dieselbe Sektion, jetzt invertiert statt hell. */}
          ...
          <div>
            ...
            <div className="prose-cic mt-6 text-fg-muted">
              <p>
                ...
                als Standardlösung, sondern als{" "}
                <strong className="font-semibold text-fg">individuellen Prozess</strong>, der
                sich an den echten Bedürfnissen unserer Kunden orientiert. Jede finanzielle
                Situation ist anders — genau deshalb setzen wir auf{" "}
                <strong className="font-semibold text-fg">
                  persönliche Analyse statt pauschale Ansätze
                </strong>
                .
              </p>
              <p>
                Unser Ziel ist es nicht, Produkte zu vermitteln, sondern{" "}
                <strong className="font-semibold text-fg">nachhaltige Verbesserungen</strong>{" "}
              ...
              <p>
                ...
                <strong className="font-semibold text-fg">
                  Transparenz, Ehrlichkeit und langfristige Partnerschaften
                </strong>{" "}
                — damit finanzielle Entscheidungen sicher und langfristig erfolgreich getroffen
                werden können.
              </p>
            </div>

            <dl className="mt-10 flex flex-wrap gap-x-12 gap-y-6 border-t border-white/15 pt-6">
              <div>
